...
NSString * const MMXConnectionStatusChangedNotification = @"com.magnet.mmx.connection.status.did.change";
NSString * const MMXConnectionStatusKey = @"com.magnet.connection.status.key";
