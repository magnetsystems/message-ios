 ...
 */
+ (void)updateCurentDeviceToken:(NSData * __nonnull)data success:(void (^ __nullable)(void))success failure:(void (^ __nullable)(NSError * __nonnull))failure;
 ...
 */
+ (MMDevice * __nonnull)currentDevice;
